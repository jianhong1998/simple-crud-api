...
class UserDataModel
    extends Model<
        InferAttributes<UserDataModel>,
        InferCreationAttributes<UserDataModel>
    >
    implements FullUserAttribute
{
    ...
    public setDepartment!: BelongsToSetAssociationMixin<
    ...
    public static associate() {
        UserDataModel.belongsTo(UserDepartmentDataModel, {
