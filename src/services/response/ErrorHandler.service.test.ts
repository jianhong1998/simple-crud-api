...
describe('class ErrorHandler', () => {
    describe('handlerUnknownError()', () => {
        ...
        it.concurrent(
            'should return the given string input when input is string',
            () => {
        ...
        it.concurrent(
            'should return the error.message when input is instance of Error',
            () => {
        ...
        it.concurrent(
            'should return the input in string format when input is not string and not instance of Error',
            () => {
                const testError1 = 1;
        ...
        it.concurrent(
            'should return json string when input is an object and is not instance of Error',
            () => {
