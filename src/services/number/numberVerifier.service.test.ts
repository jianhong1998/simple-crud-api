...
describe('class NumberVerifier', () => {
    describe('isStringValidNumber()', () => {
        ...
        it('should return true if input string contains valid number', () => {
        ...
        it('should return true if input string contains valid decimal number', () => {
        ...
        it('should return true if input string contains valid negative number', () => {
            const testString1 = '-1';
        ...
        it('should return false if input string contains non-numeric characters', () => {
    ...
    describe('getDigit()', () => {
        it('should return the number of numeric characters if input number is a positive integer', () => {
        ...
        it('should throw error if input number is a decimal', () => {
        ...
        it('should return the number of numeric characters plus 1 if input number is a negative integer', () => {
            const testNumber1 = -1;
